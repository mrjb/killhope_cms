$(function(){
	...
	$.getJSON('imageHandler.php', function(data) {
		...
		function render(data) {
			...
			if(scannedFiles.length) {
				...
				scannedFiles.forEach(function(f) {
					...
					var file = $('<li class="files"><a href="#" onclick="selectImage(\''+ f.path+'\');return false;" title="'+ f.path +'" class="files">'+icon+'<span class="name">'+ name +'</span> <span class="details">'+fileSize+'</span></a></li>');
